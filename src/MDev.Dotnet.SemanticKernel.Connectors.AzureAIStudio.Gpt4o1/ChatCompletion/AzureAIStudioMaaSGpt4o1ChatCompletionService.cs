...
using MDev.Dotnet.SemanticKernel.Connectors.AzureAIStudio.Gpt4o1.ChatCompletionWithData;
using Azure;
using System.Diagnostics.Metrics;
using Microsoft.Extensions.Logging.Abstractions;
using Azure.Core;
using Azure.Core.Pipeline;
using MDev.Dotnet.SemanticKernel.Connectors.AzureAIStudio.Gpt4o1.AzureCore;
using MDev.Dotnet.SemanticKernel.Connectors.AzureAIStudio.Gpt4o1.ChatCompletion;

namespace MDev.Dotnet.SemanticKernel.Connectors.AzureAIStudio.Gpt4o1;

internal class AzureAIStudioMaaSGpt4o1ChatCompletionService : IChatCompletionService
{
    ...
    internal AzureAIStudioMaaSGpt4o1ChatCompletionService(Uri endpoint, 
                                                        AzureKeyCredential keyCredential,
                                                        Gpt4o1ClientOptions options,
                                                        ...
                                                        ILogger? logger = null)
    {
        ...
        if (options == null)
        {
            options = new Gpt4o1ClientOptions();
        }
    ...
    private ChatMessageContent ToChatMessageContent(ChatWithDataResponse chatWithDataResponse, ChatWithDataChoice chatWithDataChoice)
    {
        ...
        // Add Usage :
        metadatas.Add("Usage", new Gpt4o1CompletionUsage(chatWithDataResponse.Usage.CompletionTokens,
    ...
    public Task<IReadOnlyList<ChatMessageContent>> GetChatMessageContentsAsync(ChatHistory chatHistory, PromptExecutionSettings? executionSettings = null, Kernel? kernel = null, CancellationToken cancellationToken = default)
    {
        ...
        var chatExecutionSettings = Gpt4o1PromptExecutionSettings.FromExecutionSettings(executionSettings);
        ...
        var body = new ChatWithDataRequest()
        {
            ...
            Temperature = 1, // Only default temperature 1 is currntly supported
            TopP = 1, // Only default top_p 1 is currntly supported
            Messages = chatHistory.Select(e => new ChatWithDataMessage()
            {
                Role = e.Role == AuthorRole.System ? "user" : e.Role.ToString(), // Override of the role to user for system messages
    ...
    internal RequestUriBuilder GetUri(string operationPath)
    {
        ...
        builder.AppendPath("/" + operationPath + "?api-version=2024-10-01-preview", escape: false);
        return builder;
    }
